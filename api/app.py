...
def get_response(user_input):
    ...
    questions = ['hi, how are you doing?','i am fine. how about yourself?','How are you today?', 'What have you been up to?', 'What do you think of the ' + random.choice(topics) + '?']
    responses = ['i am fine. how about yourself?','i am pretty good. thanks for asking.','I am a chatbot and I do not have emotions, but thank you for asking!', 
